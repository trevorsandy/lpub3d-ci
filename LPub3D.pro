# LPub3D LDV qmake Configuration settings
...
# CONFIG+=BUILD_GL2P         # override USE_LDV_SYSTEM_LIBS for libgl2ps
...
BUILD_LDV_LIBS {
    ...
    message("~~~ LDV LIBRARIES $$upper($$BUILD_ARCH) $${POSTFIX} STATIC $${BUILD} ~~~")
    message("~~~ LDV LIBRARIES USING $${WHICH_LIBS} OPENGL LIBS ~~~")
    isEmpty(USE_LDV_3RD_PARTY_LIBS):isEmpty(USE_LDV_SYSTEM_LIBS): \
    CONFIG += USE_LDV_SYSTEM_LIBS
