...
: <<'BLOCK_COMMENT'
export GITHUB=true
export GITHUB_REPOSITORY=trevorsandy/lpub3d-ci
...
export GITHUB_WORKSPACE=/Users/trevorsandy/Development/lpub3d-ci
...
chmod +x lpub3d-ci/builds/utilities/ci/github/macos-build.sh && \
       ./lpub3d-ci/builds/utilities/ci/github/macos-build.sh
