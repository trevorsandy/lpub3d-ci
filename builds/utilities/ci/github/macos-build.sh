...
wget -q ${LP3D_LIBS_BASE}/lpub3dldrawunf.zip -O ${LP3D_3RD_PARTY_PATH}/lpub3dldrawunf.zip || :
...
wget -q ${LP3D_LIBS_BASE}/complete.zip -O ${LP3D_3RD_PARTY_PATH}/complete.zip || :
...
wget -q ${LP3D_LIBS_BASE}/tenteparts.zip -O ${LP3D_3RD_PARTY_PATH}/tenteparts.zip || :
...
wget -q ${LP3D_LIBS_BASE}/vexiqparts.zip -O ${LP3D_3RD_PARTY_PATH}/vexiqparts.zip || :
