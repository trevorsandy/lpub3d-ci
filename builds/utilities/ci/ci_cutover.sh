...
function ShowHelp() {
    ...
    echo
    echo "Purpose:"
    echo "This script is used to 'cutover' development [lpub3dnext] or maintenance [lpub3d-ci] repository commits, one at a time, to production."
    ...
    echo
    echo "Preq 3 of 3 create and checkout a CUTOVER branch in the lpub3d-ci repository at the"
    ...
    echo
    echo "Step 4 of 5 Copy README.txt and RELEASE_NOTES.html from 'lpub3d' back to 'lpub3d-ci'"
    echo "  \$ cp -f lpub3d/mainApp/docs/README.txt lpub3d-ci/mainApp/docs/"
    echo "  \$ cp -f lpub3d/mainApp/docs/RELEASE_NOTES.html lpub3d-ci/mainApp/docs/"
    echo
    echo "Execution sequence:"
    echo "  - copy lpub3d-ci content to lpub3d folder"
    echo "  - preserve lpub3d git database"
    echo "  - rename all files with 'lpub3d-ci' in the name to 'lpub3d'"
    echo "  - change all occurrences of 'lpub3d-ci' to 'lpub3d'"
    ...
    echo
    echo "Move from lpub3d-ci to lpub3d-obs repository"
    echo "  \$ env TO_REPO=lpub3d-obs MSG='Open Build Service Integration and Test' TAG=v2.4.8 $0"
    echo
    echo "Move from lpub3d-ci to lpub3d repository"
    ...
    echo
    echo "Move from lpub3dnext to lpub3d-ci repository"
    echo "Step 1 of 1 Maintenance commits [Change lpub3d-ci branch to NEXT_IN and execute for each"
    echo "commit except the final one for version change]"
    echo "  \$ env TO_REPO=lpub3d-ci FROM_REPO=lpub3dnext MSG='<commit hash> <commit message>' TAG=v2.4.8 CFG=yes $0"
    echo
}
