...
wget ${LP3D_LIBS_BASE}/lpub3dldrawunf.zip -O /dist/lpub3dldrawunf.zip || :
[ ! -f "/dist/complete.zip" ] && \
wget ${LP3D_LIBS_BASE}/complete.zip -O /dist/complete.zip || :
[ ! -f "/dist/tenteparts.zip" ] && \
wget ${LP3D_LIBS_BASE}/tenteparts.zip -O /dist/tenteparts.zip || :
[ ! -f "/dist/vexiqparts.zip" ] && \
wget ${LP3D_LIBS_BASE}/vexiqparts.zip -O /dist/vexiqparts.zip || :
