...
Build-Depends: debhelper (>= 4.1.16), qtbase5-dev, qt5-qmake, libqt5opengl5-dev, libpng-dev, libjpeg-dev, zlib1g-dev, libboost-dev, libopenexr-dev, libsdl2-dev, libtiff5, libosmesa6, freeglut3
