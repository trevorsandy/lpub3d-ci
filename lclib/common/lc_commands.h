...
enum lcCommandId
{
	...
	LC_EDIT_ROTATESTEP_COORD_FORMAT,                   /*** LPub3D Mod - coord format DEPRECATED ***/
	LC_EDIT_ROTATESTEP_COORD_FORMAT_LDRAW,
	LC_EDIT_ROTATESTEP_COORD_FORMAT_LEOCAD,            /*** LPub3D Mod end ***/
...
enum lcTool
{
	LC_TOOL_INSERT,
	LC_TOOL_LIGHT,
	LC_TOOL_SUNLIGHT,  /*** LPub3D Mod - enable lights ***/
	LC_TOOL_AREALIGHT, /*** LPub3D Mod - enable lights ***/
	LC_TOOL_SPOTLIGHT,
	LC_TOOL_CAMERA,
	LC_TOOL_SELECT,
	LC_TOOL_MOVE,
