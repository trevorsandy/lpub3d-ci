...
enum lcCommandId
{
	...
	LC_EDIT_ACTION_BUILD_MOD,                             /*** LPub3D Mod - Build Mod Menu ***/
	...
	LC_EDIT_ACTION_LAST = LC_EDIT_ACTION_RESET_TRANSFORM, /*** LPub3D Mod - transform command ***/
	LC_EDIT_CANCEL,
	LC_VIEW_PREFERENCES,
	LC_VIEW_ZOOM_IN,
	LC_VIEW_ZOOM_OUT,
...
enum class lcTool
{
	...
	Roll,
	ZoomRegion,
	RotateStep,    /*** LPub3D Mod - Rotate Step Menu ***/
	Count
};
