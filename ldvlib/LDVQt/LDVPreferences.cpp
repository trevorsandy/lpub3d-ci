	  ...
	  checkAbandon(true)
{
	...
	connect( aaLinesButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	...
	connect( transparentButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( wireframeThicknessSlider, SIGNAL( valueChanged(int) ), this, SLOT( enableApply() ) );
	connect( edgesOnlyButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( conditionalLinesButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( conditionalLinesButton, SIGNAL( toggled(bool) ), this, SLOT( doConditionalShow(bool) ) );
	connect( conditionalShowAllButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( conditionalShowControlPtsButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( wireframeFogButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( wireframeRemoveHiddenLineButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( highQualityLinesButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( alwaysBlackLinesButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( alwaysBlackLinesButton, SIGNAL( clicked() ), this, SLOT( doAlwaysBlackLines() ) );
	connect( edgeThicknessSlider, SIGNAL( valueChanged(int) ), this, SLOT( enableApply() ) );
	connect( processLdconfigLdrButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( randomColorsButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( partBoundingBoxOnlyBox, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( qualityLightingButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( subduedLightingButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( specularLightingButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( alternateLightingButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( crossEyedStereoButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( parallelStereoButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( stereoAmountSlider, SIGNAL( valueChanged(int) ), this, SLOT( enableApply() ) );
	connect( colorCutawayButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( monochromeCutawayButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	...
	connect( flatShadingButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( smoothCurvesButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( nearestFilteringButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( bilinearFilteringButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( trilinearFilteringButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( anisotropicFilteringButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( anisotropicFilteringButton, SIGNAL( clicked() ), this, SLOT( doAnisotropic() ) );
	...
	connect( lowQualityStudsButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( hiresPrimitivesButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	...
	connect( enableBFCButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( bfcRedBackFaceButton, SIGNAL( toggled(bool) ), this, SLOT( enableApply() ) );
	connect( bfcGreenFrontFaceButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( bfcBlueNeutralFaceButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( wireframeButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( edgeLinesButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( edgeLinesButton, SIGNAL( toggled(bool) ), this, SLOT( doEdgeLines(bool) ) );
	connect( lightingButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( lightingButton, SIGNAL( toggled(bool) ), this, SLOT( doLighting(bool) ) );
	connect( lightingDir11, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( lightingDir12, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( lightingDir13, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( lightingDir21, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( lightingDir22, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( lightingDir23, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( lightingDir31, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( lightingDir32, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( lightingDir33, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( effectsUseLIGHTDATButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( effectsUseLIGHTDATButton, SIGNAL( toggled(bool) ), this, SLOT( doDrawLightDats() ) );
	connect( effectsReplaceStandarLightButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( effectsHideLIGHTButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( stereoButton, SIGNAL( toggled(bool) ), this, SLOT( doStereo(bool) ) );
	connect( stereoButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( wireframeCutawayButton, SIGNAL( toggled(bool) ), this, SLOT( doWireframeCutaway(bool) ) );
	connect( wireframeCutawayButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( primitiveSubstitutionButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( primitiveSubstitutionButton, SIGNAL( toggled(bool) ), this, SLOT( doPrimitiveSubstitution(bool) ) );
	connect( textureStudsButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( textureStudsButton, SIGNAL( toggled(bool) ), this, SLOT( doTextureStuds(bool) ) );
	connect( useTextureMapsButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	...
	connect( updatesNoproxyButton, SIGNAL( clicked() ), this, SLOT( disableProxy() ) );
	connect( updatesWindowsproxyButton, SIGNAL( clicked() ), this, SLOT( enableProxy() ) );
	connect( updatesProxyButton, SIGNAL( clicked() ), this, SLOT( enableProxy() ) );
	connect( updatesMissingpartsButton, SIGNAL( toggled(bool) ), this, SLOT( doUpdateMissingparts(bool) ) );
	connect( updatesMissingpartsButton, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	...
	connect( automateEdgeColorBox, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( automateEdgeColorBox, SIGNAL( clicked() ), this, SLOT( doAutomateEdgeColor()) );
	connect( automateEdgeColorButton, SIGNAL( clicked() ), this, SLOT( studStyleAndEdgeColor()) );

	connect( useStudStyleBox, SIGNAL( clicked() ), this, SLOT( enableApply() ) );
	connect( useStudStyleBox, SIGNAL( clicked() ), this, SLOT( doStudStyle()) );
