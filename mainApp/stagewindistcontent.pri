...
win32: stagewindistcontent {
    ...
    stage3rdexe {
        ...
        CONFIG(release, debug|release) {
            release: message("~~~ $${LPUB3D} RELEASE BUILD - 3RD PARTY EXEs STAGED TO: $$system_path( $$absolute_path($$LPUB3D_STG_3RD_PATH) ) ~~~")
        ...
        CONFIG(debug, debug|release): message("~~~ $${LPUB3D} DEBUG BUILD - 3RD PARTY EXECUTABLES WILL NOT BE STAGED ~~~")
    }

    stage3rdexeconfig {
        message("~~~ $${LPUB3D} 3RD PARTY EXECUTABLE CONFIG FILES WILL BE STAGED ~~~")
    ...
    stage3rdcontent {
        message("~~~ $${LPUB3D} 3RD PARTY RESOURCES AND DOCUMENTATION WILL BE STAGED ~~~")
