    ...
    : QSyntaxHighlighter(parent)
{
    ...
    const QString LPubBodyMetaPatterns[] =
    {
        ...
        QStringLiteral("\\bAREA_COLUMNS\\b"),
        QStringLiteral("\\bAREA_ROWS\\b"),
        ...
        QStringLiteral("\\bSPOT_FALLOFF\\b"),
    ...
    const QString LeoCADBodyMetaPatterns[] =
    {
        ...
        QStringLiteral("(?:(?<=LEOCAD LIGHT AREA_ROWS \\d{1} )|(?<=LEOCAD LIGHT AREA_ROWS \\d{2} )|(?<=LEOCAD LIGHT AREA_ROWS \\d{3} ))\\bAREA_COLUMNS\\b"),
        QStringLiteral("\\bLEOCAD LIGHT AREA_GRID_KEY\\b"),
        QStringLiteral("\\bLEOCAD LIGHT AREA_ROWS\\b"),
        ...
        QStringLiteral("\\bLEOCAD LIGHT CUTOFF_DISTANCE\\b"),
        QStringLiteral("\\bLEOCAD LIGHT CUTOFF_DISTANCE_KEY\\b"),
        QStringLiteral("\\bLEOCAD LIGHT DIFFUSE\\b"),
        QStringLiteral("\\bLEOCAD LIGHT DIFFUSE_KEY\\b"),
        QStringLiteral("(?:(?<=LEOCAD LIGHT WIDTH \\d{1} )|(?<=LEOCAD LIGHT WIDTH \\d{2} )|(?<=LEOCAD LIGHT WIDTH \\d{3} ))\\bHEIGHT\\b"),
        ...
        QStringLiteral("\\bLEOCAD LIGHT POWER\\b"),
        QStringLiteral("\\bLEOCAD LIGHT POWER_KEY\\b"),
        QStringLiteral("\\bLEOCAD LIGHT RADIUS\\b"),
        QStringLiteral("\\bLEOCAD LIGHT RADIUS_AND_SPOT_BLEND_KEY\\b"),
        QStringLiteral("\\bLEOCAD LIGHT RADIUS_KEY\\b"),
        QStringLiteral("\\bLEOCAD LIGHT SHADOWLESS\\b"),
        QStringLiteral("\\bLEOCAD LIGHT SHAPE\\b"),
        QStringLiteral("\\bLEOCAD LIGHT SHAPE_KEY\\b"),
        QStringLiteral("\\bLEOCAD LIGHT SIZE\\b"),
        QStringLiteral("\\bLEOCAD LIGHT SIZE_KEY\\b"),
        QStringLiteral("\\bLEOCAD LIGHT SPECULAR\\b"),
        QStringLiteral("\\bLEOCAD LIGHT SPECULAR_KEY\\b"),
        QStringLiteral("\\bLEOCAD LIGHT SPOT_BLEND\\b"),
        QStringLiteral("\\bLEOCAD LIGHT SPOT_FALLOFF\\b"),
        QStringLiteral("\\bLEOCAD LIGHT SPOT_FALLOFF_KEY\\b"),
        QStringLiteral("\\bLEOCAD LIGHT SPOT_SIZE\\b"),
        QStringLiteral("\\bLEOCAD LIGHT SPOT_SIZE_KEY\\b"),
        QStringLiteral("\\bLEOCAD LIGHT SPOT_TIGHTNESS\\b"),
        QStringLiteral("\\bLEOCAD LIGHT SPOT_TIGHTNESS_KEY\\b"),
        QStringLiteral("\\bLEOCAD LIGHT STRENGTH\\b"),
        QStringLiteral("\\bLEOCAD LIGHT STRENGTH_KEY\\b"),
        ...
        QStringLiteral("\\bLEOCAD LIGHT WIDTH\\b"),
