...
void Gui::applyLightSettings()
{
    ...
    if (currentStep) {
        ...
        for (const std::unique_ptr<lcLight>& Light : ActiveModel->GetLights()) {
            ...
            // POVRay Light
            lightMeta.povrayLight.setValue(POVRayLight);

            // Shadowless
            lightMeta.shadowless.setValue(Light->GetCastShadow());
            ...
            else
            {
                ...
                // Cutoff Distance
                if (Light->GetEnableBlenderCutoff() && (notEqual(Light->GetBlenderCutoffDistance(), lightDefault.cutoffDistance))) {
            ...
            case lcLightType::Point:
                ...
                {
                    // Point Radius
                    if (notEqual(Light->GetPointBlenderRadius(), lightDefault.pointRadius)) {
            ...
            case lcLightType::Spot:
                ...
                {
                    // Spot Radius
                    if (notEqual(Light->GetSpotBlenderRadius(), lightDefault.spotRadius)) {
            ...
            case lcLightType::Directional:
                {
                    if (!POVRayLight)
                    {
                        ...
                        if (notEqual(Light->GetDirectionalBlenderAngle(), lightDefault.sunAngle)) {
