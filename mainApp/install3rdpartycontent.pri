...
if (copy3rdexe|copy3rdexeconfig|copy3rdcontent) {
    ...
    unix:!macx {
        ...
        message("~~~ $${LPUB3D} 3RD_INSTALL TO EXE DEST: $$THIRD_PARTY_EXE_DIR/3rdParty ~~~")
    }
...
copy3rdexe {
    ...
    message("~~~ $${LPUB3D} $$upper($${BUILD_CONF}) BUILD - 3RD PARTY $${BUILD} EXECUTABLES WILL BE INSTALLED ~~~")
...
copy3rdexeconfig {
    message("~~~ $${LPUB3D} 3RD PARTY EXECUTABLE CONFIG FILES WILL BE INSTALLED ~~~")
    win32 {
...
copy3rdcontent {
    message("~~~ $${LPUB3D} 3RD PARTY RESOURCES AND DOCUMENTATION WILL BE INSTALLED ~~~")
    win32: EXT = .txt
    else: EXT =
