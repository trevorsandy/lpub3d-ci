...
stage3rdassets {
    ...
    stage3rdexe {
        ...
        # use CONFIG+=stagerenderers to override not staging in debug mode
        CONFIG(release, debug|release)|stagerenderers {

            message("~~~ $${LPUB3D} 3RD PARTY RENDERER ASSETS WILL BE STAGED ~~~")

            exists($${LDGLITE_INS_EXE}) {
                ldglite_stg.files   += $$LDGLITE_INS_EXE
                ldglite_stg.path     = $$LDGLITE_STG_DIR

                INSTALLS            += ldglite_stg
            ...
            message("~~~ $${LPUB3D} 3RD PARTY RENDERER ASSETS WILL NOT BE STAGED ~~~")
        }
    }

    stage3rdconfig {
        message("~~~ $${LPUB3D} 3RD PARTY RENDERER EXECUTABLE CONFIG FILES WILL BE STAGED ~~~")
        ...
        raytracer_stage {
            ...
            INSTALLS += raytracer_stg_resources_config

            message("~~~ $${LPUB3D} 1 OF 2 $$upper($${VER_POVRAY}) CONFIG FILES STAGED ~~~")
        }
        ...
        ldview_stage {
            ...
            INSTALLS += ldview_stg_resources_config

            message("~~~ $${LPUB3D} 2 OF 2 $$upper($${VER_LDVIEW}) CONFIG FILES STAGED ~~~")
        }
    }

    stage3rdcontent {
        message("~~~ $${LPUB3D} 3RD PARTY RENDERER DOCUMENTATION AND RESOURCES WILL BE STAGED ~~~")
        ...
        ldglite_stage {
            ...
            message("~~~ $${LPUB3D} 1 OF 3 $$upper($${VER_LDGLITE}) DOCUMENTATION AND RESOURCES STAGED ~~~")
        }
        ...
        ldview_stage {
            ...
            message("~~~ $${LPUB3D} 2 OF 3 $$upper($${VER_LDVIEW}) DOCUMENTATION AND RESOURCES STAGED ~~~")
        }
        ...
        raytracer_stage {
            ...
            message("~~~ $${LPUB3D} 3 OF 3 $$upper($${VER_POVRAY}) DOCUMENTATION AND RESOURCES STAGED ~~~")
        }
    }
}
