  ...
  QString distribution;
    ...
    WT_Text WTData[] =
    {
        ...
        // WT_GUI_FADE_STEPS
        {
            ...
            "    hex [A]RGB value as there are multiple LDraw colours<br>"
            "    that use the same hex [A]RGB value.<br><br>"
            "  - Fade Color Prefix: set the using a 3-digit value<br>"
            "    that allows the renderer to recognize the Fade color.<br>"
            "    This prefix is prepended to the LDConfig colour ID.<br><br>"
            "  - Fade Percent: sets the fade color transparency<br>"
            "    between 0 and 100 percent where 0 is fully<br>"
            "    transparent and 100 is fully opaque.<br>"
            "    This value is translated to the fade color<br>"
        ...
        // WT_GUI_HIGHLIGHT_CURRENT_STEP
        {
            ...
            "  - Highlight Color Prefix: set the using a 3-digit value<br>"
            "    that allows the renderer to recognize the Highlight color.<br>"
            "    This prefix is prepended to the LDConfig colour ID.<br><br>"
